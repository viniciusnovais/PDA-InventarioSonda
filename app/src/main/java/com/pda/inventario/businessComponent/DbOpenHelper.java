...
public class DbOpenHelper extends SQLiteOpenHelper {
	...
	private void CreateTableItemColeta(SQLiteDatabase db) {
		String comando  = "CREATE TABLE PDA_TB_ITEM_COLETA ( ID_COLETA INTEGER PRIMARY KEY AUTOINCREMENT, EAN TEXT, QTDE_CONTAGEM INT, ID_INVENTARIO INT, ID_ENDERECO INT, DATA_COLETA TEXT, METODO_COLETA INT, " +
	...
	private void CreateTableProduto(SQLiteDatabase db) {
		String comando = "CREATE TABLE PDA_TB_PRODUTO (ID_PRODUTO INTEGER PRIMARY KEY AUTOINCREMENT, COD_PRODUTO TEXT, EAN TEXT, DESC_PRODUTO TEXT, PRECO INT)"; 
		db.execSQL(comando);
	}
