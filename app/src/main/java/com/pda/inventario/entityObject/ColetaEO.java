...
public class ColetaEO implements KvmSerializable {
    ...
    public ColetaEO(int idColeta, String codigoBarra, float quantidadeContagem, int idInventario, String idEndereco, String dataColeta, int metodoColeta, int tipoAtividade, int export, String codigoProduto,
